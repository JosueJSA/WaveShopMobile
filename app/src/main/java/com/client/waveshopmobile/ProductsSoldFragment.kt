...
class ProductsSoldFragment(val user:Int?, val conn:Context) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_products_sold, container, false)
    }

    private fun getProducts(id:Int?){
        CoroutineScope(Dispatchers.IO).launch {
            val call = getRetrofit().create(OrderAPI::class.java).getProductsSold("api/Orders/sold/$id")
            call.enqueue(
